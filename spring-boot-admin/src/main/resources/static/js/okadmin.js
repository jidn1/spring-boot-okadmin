...
var objOkTab = "";
layui.use(["element", "layer", "okUtils", "okTab", "okLayer", "okContextMenu", "okHoliday","okMock"], function () {
  ...
  var okTab =  layui.okTab({
    // 菜单请求路径
    url: okMock.api.baseUrl + "/system/loadMenu",
    // 允许同时选项卡的个数
    openTabNum: 30,
  ...
  $("#alertSkin").click(function () {
    okLayer.open("皮肤动画", "oauth/alertSkin.html", "50%", "45%", function (layero) {
    }, function () {
    });
  });

package spring.org.nutz.castor;
...
import spring.org.nutz.castor.castor.Object2Object;
import spring.org.nutz.lang.Lang;
import spring.org.nutz.lang.Mirror;
import spring.org.nutz.lang.TypeExtractor;
...
public class Castors {
     ...
     * 设置转换的配置
     * <p>
     * 配置对象所有的共有方法都会被遍历。只要这个方法有一个且只有一个参数，并且该参数 是一个 Castor

...
import spring.org.nutz.el.opt.custom.CustomMake;
...
import spring.org.nutz.resource.NutResource;
import spring.org.nutz.resource.Scans;
...
public class NutConf {
    ...
    private static final String DEFAULT_CONFIG = "spring/org/nutz/conf/NutzDefaultConfig.js";

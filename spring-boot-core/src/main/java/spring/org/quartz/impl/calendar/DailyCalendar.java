 ...
 * as, for example, {@link WeeklyCalendar
...
public class DailyCalendar extends BaseCalendar {
     ...
     *                          time range
     */
    public DailyCalendar(spring.org.quartz.Calendar baseCalendar,
     ...
     * <code>{@link TimeZone#getDefault()}</code> time zone unless an explicit
     * time zone is set via <code>{@link BaseCalendar#setTimeZone(TimeZone)}</code>.
     * You should use <code>{@link #DailyCalendar(spring.org.quartz.Calendar, java.util.TimeZone, long, long)}</code>

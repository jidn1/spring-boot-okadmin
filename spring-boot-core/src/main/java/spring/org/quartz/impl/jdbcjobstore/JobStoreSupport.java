...
import spring.org.quartz.ObjectAlreadyExistsException;
...
import spring.org.quartz.Trigger.CompletedExecutionInstruction;
import spring.org.quartz.Trigger.TriggerState;
import spring.org.quartz.TriggerKey;
import spring.org.quartz.impl.DefaultThreadExecutor;
...
import spring.org.quartz.spi.SchedulerSignaler;
import spring.org.quartz.spi.ThreadExecutor;
import spring.org.quartz.spi.TriggerFiredBundle;
import spring.org.quartz.spi.TriggerFiredResult;
...
public abstract class JobStoreSupport implements JobStore, Constants {
    ...
    /**
     * <p>
     * Pause all of the <code>{@link Trigger}s</code> matching the
     * given groupMatcher.
     * </p>
     *

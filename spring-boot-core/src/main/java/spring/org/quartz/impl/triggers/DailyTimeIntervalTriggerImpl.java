...
/**
 * A concrete implementation of DailyTimeIntervalTrigger that is used to fire a <code>{@link JobDetail}</code>
 ...
 * (see {@link #setRepeatIntervalUnit(DateBuilder.IntervalUnit)}) during a given time window on specified days of the week.</p>
 *
...
public class DailyTimeIntervalTriggerImpl extends AbstractTrigger<DailyTimeIntervalTrigger> implements DailyTimeIntervalTrigger, CoreTrigger {
    ...
    /**
     * @see AbstractTrigger#updateWithNewCalendar(spring.org.quartz.Calendar, long)
     */
    @Override

...
package spring.org.quartz.impl.triggers;
...
import spring.org.quartz.DateBuilder.IntervalUnit;
import spring.org.quartz.JobExecutionException;
import spring.org.quartz.CronTrigger;
import spring.org.quartz.JobExecutionContext;
import spring.org.quartz.spi.OperableTrigger;


/**
 * <p>A concrete <code>{@link Trigger}</code> that is used to fire a <code>{@link JobDetail}</code>
 ...
 * (see {@link #setRepeatIntervalUnit(DateBuilder.IntervalUnit)}) as specified in the trigger's definition.
...
public class CalendarIntervalTriggerImpl extends AbstractTrigger<CalendarIntervalTrigger> implements CalendarIntervalTrigger, CoreTrigger {
     ...
     */
    @Override
    public void updateAfterMisfire(spring.org.quartz.Calendar cal) {
     ...
     */
    @Override
    public void triggered(spring.org.quartz.Calendar calendar) {
        timesTriggered++;
    ...
    /**
     *
     * @see OperableTrigger#updateWithNewCalendar(spring.org.quartz.Calendar, long)
     */
    @Override
    public void updateWithNewCalendar(spring.org.quartz.Calendar calendar, long misfireThreshold)
    {
     ...
     */
    @Override
    public Date computeFirstFireTime(spring.org.quartz.Calendar calendar) {

 ...
 * responding to scheduler events by allowing the user to specify <code>{@link JobListener}</code>,
 * <code>{@link TriggerListener}</code> and <code>{@link SchedulerListener}</code>
 * classes.
 * </p>
 *
 * <p>

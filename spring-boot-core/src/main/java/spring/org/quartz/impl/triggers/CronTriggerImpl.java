...
import spring.org.quartz.CronExpression;
...
public class CronTriggerImpl extends AbstractTrigger<CronTrigger> implements CronTrigger, CoreTrigger {
     ...
     * </p>
     *
     * @see TriggerUtils#computeFireTimesBetween(OperableTrigger, spring.org.quartz.Calendar, java.util.Date, java.util.Date)
     */
    @Override

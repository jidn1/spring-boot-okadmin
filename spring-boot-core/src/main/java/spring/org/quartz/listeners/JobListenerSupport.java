 ...
 * under the License.
 */
package spring.org.quartz.listeners;
 ...
 * <code>{@link JobListener}</code>.
 *
 * <p>
 * The methods in this class are empty so you only need to override the
 * subset for the <code>{@link JobListener}</code> events
 * you care about.
 * </p>
 *
 * <p>
 * You are required to implement <code>{@link JobListener#getName()}</code>
